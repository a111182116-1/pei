    ...
    <div className="min-h-screen bg-avocado-50 text-avocado-900 font-sans">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        ...
        <motion.div 
          ...
          className="absolute top-[35%] left-[60%] w-72 h-72 bg-avocado-100/40 rounded-full blur-3xl opacity-50"
        />
        ...
        {[
          { top: '5%', left: '10%', delay: 0, size: 'text-2xl' },
          { top: '15%', left: '85%', delay: 1, size: 'text-4xl' },
          { top: '25%', left: '30%', delay: 2, size: 'text-3xl' },
          { top: '35%', left: '70%', delay: 3, size: 'text-5xl' },
          { top: '45%', left: '15%', delay: 4, size: 'text-2xl' },
          { top: '55%', left: '90%', delay: 0.5, size: 'text-4xl' },
          { top: '65%', left: '25%', delay: 1.5, size: 'text-3xl' },
          { top: '75%', left: '80%', delay: 2.5, size: 'text-6xl' },
          { top: '85%', left: '10%', delay: 3.5, size: 'text-4xl' },
          { top: '95%', left: '50%', delay: 4.5, size: 'text-2xl' },
          { top: '10%', left: '60%', delay: 2, size: 'text-3xl' },
          { top: '40%', left: '40%', delay: 1, size: 'text-4xl' },
          { top: '80%', left: '35%', delay: 3, size: 'text-2xl' },
          { top: '20%', left: '20%', delay: 4, size: 'text-5xl' },
          { top: '70%', left: '65%', delay: 0, size: 'text-3xl' },
        ].map((pos, i) => (
          <motion.div
            key={i}
            initial={{ opacity: 0 }}
            ...
            transition={{ duration: 6 + Math.random() * 4, repeat: Infinity, delay: pos.delay }}
